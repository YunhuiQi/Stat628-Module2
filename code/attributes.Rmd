...
setwd('/Users/haoqiming/Dropbox/628 module2/data')
words <- read.csv('review_train.csv')
...
attribute <- read.csv('attr.csv')
b <- read.csv('bs_train_select.csv')
...
choosedata<-read.table("importance.txt",header = T)
